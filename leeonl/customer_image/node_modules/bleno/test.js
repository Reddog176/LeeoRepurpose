...
var StaticReadOnlyCharacteristic = function(uuid_in,uuid_second) {
...
var DynamicReadOnlyCharacteristic = function() {
  DynamicReadOnlyCharacteristic.super_.call(this, {
    uuid: '0000000000001000800000805F9B0002',
    properties: ['read']
  });
};
...
var WriteOnlyCharacteristic = function() {
  WriteOnlyCharacteristic.super_.call(this, {
    uuid: '0000000000001000800000805F9B0003',
...
var readCount = 0;
WriteOnlyCharacteristic.prototype.onReadRequest = function(offset, callback) {
  var result = this.RESULT_SUCCESS;
  readCount = readCount + 1;
  var data = new Buffer('read count: '+readCount.toString());
  console.log("Yo, I just read it "+readCount.toString());
...
var NotifyOnlyCharacteristic = function() {
  NotifyOnlyCharacteristic.super_.call(this, {
    uuid: '0000000000001000800000805F9B0004',
    properties: ['notify']
  });
};
...
function SampleService() {
  SampleService.super_.call(this, {
    uuid: '0000000000001000800000805F9B0000',
    characteristics: [
       new WriteOnlyCharacteristic()
      //new StaticReadOnlyCharacteristic('0000000000001000800000805F9B0001','2901')
    ]
  });
}
...
bleno.on('stateChange', function(state) {
  ...
  if (state === 'poweredOn') {
    bleno.startAdvertising('test', ['0000000000001000800000805F9B0000']);
  } else {
